...
plot...
    (OFT_Out_SpectralResponse(1,:),OFT_Out_SpectralResponse(4,:),...
    OFT_Out_SpectralResponse(1,:),OFT_Out_SpectralResponse(3,:),...
    OFT_Out_SpectralResponse(1,:),OFT_Out_SpectralResponse(2,:),...
...%     OFT_RICD_Response(1,:), OFT_RICD_Response(4,:), ...
...%     OFT_RICD_Response(1,:), OFT_RICD_Response(3,:), ...
...%     OFT_RICD_Response(1,:), OFT_RICD_Response(2,:), ...
    OFT_CIEStandardObserver_SpectralCurves(1,:), OFT_CIEStandardObserver_SpectralCurves(4, :),'--', ...
    OFT_CIEStandardObserver_SpectralCurves(1,:), OFT_CIEStandardObserver_SpectralCurves(3, :),'--', ...
    OFT_CIEStandardObserver_SpectralCurves(1,:), OFT_CIEStandardObserver_SpectralCurves(2, :),'--')
